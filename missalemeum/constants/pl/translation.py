...
VOTIVE_MASSES = [
    {"ref": "rorate", "id": constants.COMMUNE_C_10A, "title": TITLES[constants.COMMUNE_C_10A], "tags": ["Adwent"]},
    {
        "ref": "vultum-tuum",
    ...
    {
        "ref": "petrus-et-paulus",
        "id": constants.VOTIVE_PETERPAUL,
        "title": TITLES[constants.VOTIVE_PETERPAUL],
        "tags": ["Wotywna", "Środa", "Poza Okresem Wielkanocnym"],
    },
    {
        "ref": "petrus-et-paulus-p",
        "id": constants.VOTIVE_PETERPAULP,
        "title": TITLES[constants.VOTIVE_PETERPAUL],
        "tags": ["Wotywna", "Środa", "W Okresie Wielkanocnym"],
    },
    {
        "ref": "apostolorum",
        "id": constants.VOTIVE_APOSTLES,
        "title": TITLES[constants.VOTIVE_APOSTLES],
        "tags": ["Wotywna", "Środa", "Poza Okresem Wielkanocnym"],
    },
    {
        "ref": "apostolorum-p",
        "id": constants.VOTIVE_APOSTLESP,
        "title": TITLES[constants.VOTIVE_APOSTLES],
        "tags": ["Wotywna", "Środa", "W Okresie Wielkanocnym"],
    },
    {
        "ref": "spiritus-sanctus",
        "id": constants.VOTIVE_HOLYSPIRIT,
        "title": TITLES[constants.VOTIVE_HOLYSPIRIT],
        "tags": ["Wotywna", "Czwartek"],
    },
    {
        "ref": "spiritus-sanctus-2",
        "id": constants.VOTIVE_HOLYSPIRIT2,
        "title": TITLES[constants.VOTIVE_HOLYSPIRIT2],
        "tags": ["Wotywna", "Czwartek"],
    },
    {
        "ref": "eucharistiae-sacramento",
        "id": constants.VOTIVE_BLESSEDSACRAMENT,
        "title": TITLES[constants.VOTIVE_BLESSEDSACRAMENT],
        "tags": ["Wotywna", "Czwartek"],
    },
    {
    ...
    {
        "ref": "sancta-cruce",
        "id": constants.VOTIVE_CROSS,
        "title": TITLES[constants.VOTIVE_CROSS],
        "tags": ["Wotywna", "Piątek"],
    },
    {
        "ref": "passio",
        "id": constants.VOTIVE_PASSION,
        "title": TITLES[constants.VOTIVE_PASSION],
        "tags": ["Wotywna", "Piątek"],
    },
    {
        "ref": "cordis-jesu",
    ...
    {
        "ref": "fidei-propagatione",
        "id": constants.VOTIVE_FIDEI_PROPAGATIONE,
        "title": TITLES[constants.VOTIVE_FIDEI_PROPAGATIONE],
        "tags": ["Wotywna", "W różnych potrzebach"],
    },
    {
        "ref": "matrimonium",
        "id": constants.VOTIVE_MATRIMONIUM,
        "title": TITLES[constants.VOTIVE_MATRIMONIUM],
        "tags": ["Wotywna"],
    },
    {
        "ref": "defunctorum",
        "id": constants.VOTIVE_DEFUNCTORUM,
...
SUPPLEMENTS = {
    ...
    constants.SANCTI_12_24: [{"label": "Boże Narodzenie", "path": "/pl/supplement/3-boze-narodzenie"}],
    ...
    constants.SANCTI_12_26: [
        {
            "label": f"{KDE} na uroczystość pierwszego męczennika św. Szczepana",
            "path": "http://vetusordo.pl/objasnieniaupmss/",
        }
    ],
    ...
    constants.TEMPORA_EPI1_0: [{"label": "Okres po Objawieniu", "path": "/pl/supplement/4-okres-po-objawieniu"}],
    ...
    constants.TEMPORA_QUADP3_3: [{"label": "Wielki Post", "path": "/pl/supplement/6-wielki-post"}],
    ...
    constants.TEMPORA_QUAD6_6: [{"label": "Okres Wielkanocny", "path": "/pl/supplement/9-okres-wielkanocny"}],
    constants.TEMPORA_PASC0_0: [{"label": f"{KDE} na Wielkanoc", "path": "http://vetusordo.pl/objasnieniaenw/"}],
    constants.TEMPORA_PASC0_1: [
        {"label": f"{KDE} na poniedziałek Wielkanocny", "path": "http://vetusordo.pl/2019oenpw/"}
    ],
    constants.TEMPORA_PASC1_0: [{"label": f"{KDE} na niedzielę Białą", "path": "http://vetusordo.pl/2019oennp/"}],
    ...
    constants.TEMPORA_PASC6_6: [{"label": "Zesłanie Ducha św.", "path": "/pl/supplement/10-zeslanie-ducha-sw"}],
    ...
    constants.TEMPORA_PASC7_1: [
        {
            "label": f"{KDE} na poniedzialek w Oktawie Zesłania Ducha św.",
            "path": "/pl/supplement/commentary/poniedzialek-po-zeslaniu",
        }
    ],
    ...
    constants.TEMPORA_PENT16_0: [
        {
            "label": f"{KDE} na 16 niedzielę po Zesłaniu Ducha św.",
            "path": "/pl/supplement/commentary/16-niedziela-po-zeslaniu",
        }
    ],
    ...
    constants.TEMPORA_PENT20_0: [
        {
            "label": f"{KDE} na 20 niedzielę po Zesłaniu Ducha św.",
            "path": "/pl/supplement/commentary/20-niedziela-po-zeslaniu",
        }
    ],
    ...
    constants.TEMPORA_PENT24_0: [
        {
            "label": f"{KDE} na 24 niedzielę po Zesłaniu Ducha św.",
            "path": "/pl/supplement/commentary/24-niedziela-po-zeslaniu",
        }
    ],
    ...
    constants.SANCTI_06_29: [
        {
            "label": f"{KDE} na uroczystość śś. Apostołów Piotra i Pawła",
            "path": "http://vetusordo.pl/objasnienia2019enussapip/",
        }
    ],
